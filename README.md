...
### Installation
you can just pop it into your Plugins folder in Unreal. I built this with 5.6.1 but afaik it should work in versions as low as 5.4
the only dependency this plugin has is another one of my plugins: https://github.com/legibleguy/unreal-gas-essentials it's super light weight though, and it just ensures that the food actor is GAS-ready and has an ability system component.
